import"https://unpkg.com/boxicons@2.1.4/dist/boxicons.js";const l=document.getElementById("start"),t=document.getElementById("bg-pic"),n=t?.clientHeight??0,o=t?.clientWidth??0;l?.addEventListener("mousemove",e=>{const{x:s,y:i}=e,a=(s-o/2)/o*-3,r=`
    perspective(500px)
    scale(1)
